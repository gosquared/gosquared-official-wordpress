...
class GoSquaredOfficalTestClass extends \WP_Mock\Tools\TestCase {
	...
	public function testGSSnippet() {
		...
		$validReponse="<script>!function(g,s,q,r,d){r=g[r]=g[r]||function(){(r.q=r.q||[]).push(arguments)};d=s.createElement(q);q=s.getElementsByTagName(q)[0];d.src='//d1l6p2sc9645hc.cloudfront.net/gosquared.js';q.parentNode.insertBefore(d,q)}(window,document,'script','_gs');_gs('project_token');</script>";
