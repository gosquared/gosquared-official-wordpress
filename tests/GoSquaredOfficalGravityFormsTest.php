  ...
  public function testOutputtingGSSnippetwithProperties()
			{
				...
				$entry=Array('id' => '27', '1.3' => 'Russell', '1.6' => 'Vaughan', '2' => 'Russell@gosquared.com', '3' => 'user', '4' => '1');
				$valid_response=<<<EOD
<script>if(!window._gs) {!function(g,s,q,r,d){r=g[r]=g[r]||function(){(r.q=r.q||[]).push(arguments)};d=s.createElement(q);q=s.getElementsByTagName(q)[0];d.src='//d1l6p2sc9645hc.cloudfront.net/tracker.js';q.parentNode.insertBefore(d,q)}(window,document,'script','_gs');_gs('1234568');}_gs('identify',{"custom":{"Username":"user"},"email":"Russell@gosquared.com"})</script>
EOD;
	...
	public function testOutputtingGSSnippetwithPropertiesWithoutCreditCard()
			{
				...
				$valid_response=<<<EOD
<script>if(!window._gs) {!function(g,s,q,r,d){r=g[r]=g[r]||function(){(r.q=r.q||[]).push(arguments)};d=s.createElement(q);q=s.getElementsByTagName(q)[0];d.src='//d1l6p2sc9645hc.cloudfront.net/tracker.js';q.parentNode.insertBefore(d,q)}(window,document,'script','_gs');_gs('1234568');}_gs('identify',{"custom":[],"email":"Russell@gosquared.com"})</script>
EOD;
				$this->expectOutputString($valid_response);
				$gsSnippet = $GFform->send($entry, $form);
				print_r($gsSnippet);
